...
\newline
\newline
    SOSMC is noted to match the performance of \textbf{metropolis hastings} with lower compute usage in 3d generation examples.
\end{frame}
%section-end
